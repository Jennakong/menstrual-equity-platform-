export const SITE_NAME = "Luwá";
export const SITE_TAGLINE = "Brighter Days · Always";
export const SITE_DESCRIPTION =
  "A 12-month menstrual care subscription that funds dignity and education for a girl in need across Africa.";

export const IMPACT_STATS = [
  {
    value: "12,400+",
    label: "Girls Supported",
    description: "Girls across West Africa who've received a full year's supply",
    icon: "🌸",
  },
  {
    value: "280+",
